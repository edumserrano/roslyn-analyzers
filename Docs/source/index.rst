...
The `roslyn-analyzers repository <https://github.com/edumserrano/roslyn-analyzers>`_ was created as a learning experience about the Roslyn API. Hopefully it will grow to hold many more analyzers.
